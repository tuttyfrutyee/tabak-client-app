      ...
      <div class="container">
          <div class="row addMarginT-S">
              ...
              <div class="col s10 offset-s1 addMarginT-M">
                  <a @click="openFullscreen" class="waves-effect waves-light btn fullWidth center"><i class="material-icons right">arrow_forward</i>Başla!</a>
              </div>
          </div>
      </div>
...
export default {
  ...
  methods : {
      changeBackgroundColor(){
          document.getElementsByTagName("html")[0].style.backgroundColor = this.$store.state.uTGlobalVariables.tabakColor
      },
